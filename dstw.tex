...
Before the liquid slug burst ($ t < \SI{21.5}{s}$), all liquid slugs were rising at a nearly constant velocity ($\sim \SI{0.03}{ m / s}$), but immediately after the topmost liquid slug rupturing, it began to accelerate. 
It was ascending at a velocity of about \SI{0.18}{ m / s} just before bursting.
At this time, the rising velocity of the following liquid slug was higher than the velocity (about \SI{0.05}{ m / s}) just before the topmost liquid slug burst.
